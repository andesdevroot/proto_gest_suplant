...
class RecepcionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recepcion" do
    assert_difference('Recepcion.count') do
      post recepcions_url, params: { recepcion: { dirigente: @recepcion.dirigente, fecha: @recepcion.fecha, socio_id: @recepcion.socio_id, tema: @recepcion.tema } }
    end
  ...
  test "should update recepcion" do
    patch recepcion_url(@recepcion), params: { recepcion: { dirigente: @recepcion.dirigente, fecha: @recepcion.fecha, socio_id: @recepcion.socio_id, tema: @recepcion.tema } }
