...
class AsistenciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asistencium" do
    assert_difference('Asistencium.count') do
      post asistencia_url, params: { asistencium: { asistencia: @asistencium.asistencia, fecha: @asistencium.fecha, socio_id: @asistencium.socio_id, tipo_reunion: @asistencium.tipo_reunion } }
    end
  ...
  test "should update asistencium" do
    patch asistencium_url(@asistencium), params: { asistencium: { asistencia: @asistencium.asistencia, fecha: @asistencium.fecha, socio_id: @asistencium.socio_id, tipo_reunion: @asistencium.tipo_reunion } }
