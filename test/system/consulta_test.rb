...
class ConsultaTest < ApplicationSystemTestCase
  ...
  test "creating a Consultum" do
    ...
    fill_in "Descripción", with: @consultum.descripción
    fill_in "Diregente", with: @consultum.diregente
    fill_in "Fecha", with: @consultum.fecha
    fill_in "Socio", with: @consultum.socio_id
    fill_in "Tema", with: @consultum.tema
